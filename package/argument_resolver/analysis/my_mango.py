...
import argument_resolver.my_handlers.base
import argument_resolver.my_handlers.local_handler
import argument_resolver.analysis.my_base
...
from argument_resolver.analysis.my_base import ScriptBase, default_parser
...
class MangoAnalysis(ScriptBase):
    ...
    def save_closure(self, sink, defn, closure):
        ...
        is_sanitized = False
        print('get_sources_from_closure')
